...
response = requests.post("http://185.189.255.220:8100/payment_service/create_invoice/", json=fields)
print(response.json())
...
while i > 0:
    ...
    response = requests.post("http://185.189.255.220:8100/payment_service/get_invoice_status", json=fields)
    print(response.json())
